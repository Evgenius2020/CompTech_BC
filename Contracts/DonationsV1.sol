...
contract Donating {
    ...
    public
    {
        ...
        donation.amountOfTransactions = 0;
        Creation(id);
    }
    ...
    public 
    {
        ...
        donations[donationId].amountOfTransactions++;
        moneysenders[donationId][donations[donationId].amountOfTransactions] = msg.sender;
